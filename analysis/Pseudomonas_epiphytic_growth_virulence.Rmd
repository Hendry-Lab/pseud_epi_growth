...
epi_virulence_plot_strains <- ggplot(subset_data_72, aes(x = mean_CFU_per_10_leafdiscs, y = 1-surv_prob)) +
  ...
  geom_smooth(method = "lm", se = FALSE, color = "chocolate4", linewidth = 0.5) +
  labs(title = "72 Hours",
...
epi_virulence_plot_species <- ggplot(subset_data_72, aes(x = mean_CFU_per_10_leafdiscs, y = (1-surv_prob))) +
